...
/**
 * Servlet implementation class AddSinglePassengerController
 */
@WebServlet("/AddSinglePassengerController")
public class AddSinglePassengerController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddSinglePassengerController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		passenger.setAadher_no(request.getParameter("aadher"));
		passenger.setName(request.getParameter("name"));
		passenger.setAge(Integer.parseInt(request.getParameter("age")));
